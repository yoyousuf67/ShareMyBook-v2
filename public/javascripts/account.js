...
"async": true,
"crossDomain": true,
"url": "https://sharemybook.herokuapp.com/book/wishlist/wishlist_display",
"method": "GET",
"headers": {
...
function account() {
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": "https://sharemybook.herokuapp.com/auth/account/display_account_info",
    "method": "GET",
    "headers": {
      "cache-control": "no-cache",
...
function render_form(data) {
  ...
  //Function to submit form
    ...
    $("#update_form").submit(function(e) {
      ...
      $.ajax({
       type: "POST",
        url: "https://sharemybook.herokuapp.com/auth/account/update_info",
        data: $(this).serialize(),
  ...
  function my_books_for_sale() {
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": "https://sharemybook.herokuapp.com/book/sale/sale_display",
      "method": "GET",
      "headers": {
        "cache-control": "no-cache",
...
function remove_from_wishlist(book_id){
  ...
  "async": true,
  "crossDomain": true,
  "url": "https://sharemybook.herokuapp.com/book/remove_from/wishlist/"+book_id,
  "method": "GET",
  "headers": {
    "cache-control": "no-cache"
  }
...
$.ajax(settings).done(function (response) {
        ...
        "async": true,
        "crossDomain": true,
        "url": "https://sharemybook.herokuapp.com/book/add_to_cart/"+book_id,
        "method": "GET",
        "headers": {
          "cache-control": "no-cache",
...
function del_book(book_id) {
  ...
  "async": true,
  "crossDomain": true,
  "url": "https://sharemybook.herokuapp.com/book/delete/"+book_id,
  "method": "DELETE",
  "headers": {
    "cache-control": "no-cache",
  }
