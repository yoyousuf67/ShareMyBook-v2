...
function add_to_cart(book_id) {
  ...
  xhr.open("GET", "https://sharemybook.herokuapp.com/book/add_to_cart/"+book_id);
...
//  $('.ui.inline.nag.cookie.'+book_id).nag('show');
  ...
  xhr.open("GET", "https://sharemybook.herokuapp.com/book/add_to_wishlist/"+book_id);
  xhr.setRequestHeader("cache-control", "no-cache");
  xhr.send(data);
}
...
var logout = function(){
  ...
  xhr.open("GET", "https://sharemybook.herokuapp.com/auth/logout");
